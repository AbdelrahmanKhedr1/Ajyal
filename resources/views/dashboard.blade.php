                                ...
                                <ul class="team-activity">
                                    <li class="product-list clearfix">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="status">
                                                <div class="progress">
                                                    <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="49" aria-valuemin="0"
                                    ...
                                    <div class="products-sold-container">
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="img/mobiles/mob1.jpg" alt="Google Dashboard">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="img/mobiles/mob2.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="img/mobiles/mob3.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="img/mobiles/mob4.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="img/mobiles/mob5.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="img/mobiles/mob6.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="img/mobiles/mob7.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="img/mobiles/mob8.jpg" alt="Google Dashboard">
                                                <div class="product-title">
...
<!-- Polyfill JS -->
<script src="{{URL::asset('vendor/polyfill/polyfill.min.js')}}"></script>
<script src="{{URL::asset('vendor/polyfill/class-list.min.js')}}"></script>

<!-- Apex Charts -->
<script src="{{URL::asset('vendor/apex/apexcharts.min.js')}}"></script>
<script src="{{URL::asset('vendor/apex/custom/home/lineRevenueGradientGraph.js')}}"></script>
<script src="{{URL::asset('vendor/apex/custom/home/radialTasks.js')}}"></script>
<script src="{{URL::asset('vendor/apex/custom/home/lineNewCustomersGradientGraph.js')}}"></script>

<!-- Peity Charts -->
<script src="{{URL::asset('vendor/peity/peity.min.js')}}"></script>
<script src="{{URL::asset('vendor/peity/custom-peity.js')}}"></script>

<!-- Circleful Charts -->
<script src="{{URL::asset('vendor/circliful/circliful.min.js')}}"></script>
<script src="{{URL::asset('vendor/circliful/circliful.custom.js')}}"></script>
@endsection
