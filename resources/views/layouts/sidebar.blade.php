...
<nav id="sidebar" class="sidebar-wrapper">
    ...
    <div class="sidebar-user-details">
        <div class="user-profile">
            <img src="{{ URL::asset('img/user7.png') }}" class="profile-thumb" alt="Admin Dashboards">
            <span class="status-label"></span>
        </div>
        <h6 class="profile-name"><a href="{{route('dashboard.profile.edit')}}">{{ Auth::user()->name }}</a></h6>
        <div class="profile-actions">
            <a href="{{route('dashboard.profile.edit')}}" data-toggle="tooltip" data-placement="top" title=""
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <a :href="route('logout')"
                        onclick="event.preventDefault();
                                    this.closest('form').submit();" class="red">
            ...
            <ul>
                ...
                <li>
                    ...
                    {{-- <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{route('dashboard.dashboard')}}" class="current-page">Dashboard</a>
                                    </li>
                                    <li>
