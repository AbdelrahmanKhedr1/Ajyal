...
{{--
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{ URL::asset('assets/images/products/product-1.jpg') }}" alt="#">
                            <div class="button">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <img src="{{URL::asset('assets/images/products/product-2.jpg')}}" alt="#">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <img src="{{URL::asset('assets/images/products/product-3.jpg')}}" alt="#">
                        <div class="button">
                            <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <img src="{{URL::asset('assets/images/products/product-4.jpg')}}" alt="#">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <img src="{{URL::asset('assets/images/products/product-5.jpg')}}" alt="#">
                        <div class="button">
                            <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <img src="{{URL::asset('assets/images/products/product-6.jpg')}}" alt="#">
                        <div class="button">
                            <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <img src="{{URL::asset('assets/images/products/product-7.jpg')}}" alt="#">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <img src="{{URL::asset('assets/images/products/product-8.jpg')}}" alt="#">
                        <div class="button">
                            <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                        </div>
                    </div>
